...
public class PlayerAttack : MonoBehaviour {
    ...
    void CheckInput ()
    {
        ...
        if (Input.GetKeyDown(KeyCode.Alpha1))
        {
            ...
            if (playerMovement.FinishedMovement == true && fadeImages[0] != 1 && canAttack)
            {
                fadeImages[0] = 1;
        ...
        {
            playerMovement.TargetPosition = transform.position;
            if (playerMovement.FinishedMovement == true && fadeImages[1] != 1 && canAttack)
            {
                fadeImages[1] = 1;
        ...
        {
            playerMovement.TargetPosition = transform.position;
            if (playerMovement.FinishedMovement == true && fadeImages[2] != 1 && canAttack)
            {
                fadeImages[2] = 1;
        ...
        {
            playerMovement.TargetPosition = transform.position;
            if (playerMovement.FinishedMovement == true && fadeImages[3] != 1 && canAttack)
            {
                fadeImages[3] = 1;
        ...
        {
            playerMovement.TargetPosition = transform.position;
            if (playerMovement.FinishedMovement == true && fadeImages[4] != 1 && canAttack)
            {
                fadeImages[4] = 1;
        ...
        {
            playerMovement.TargetPosition = transform.position;
            if (playerMovement.FinishedMovement == true && fadeImages[5] != 1 && canAttack)
            {
                fadeImages[5] = 1;
        ...
        if (Input.GetKey(KeyCode.Space))
        {
            ...
            transform.rotation = Quaternion.Slerp(transform.rotation, Quaternion.LookRotation(targetPos - transform.position), 15 * Time.deltaTime);
        }
    }
